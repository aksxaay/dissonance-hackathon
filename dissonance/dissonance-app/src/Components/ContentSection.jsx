          ...
          <div className="px-20 py-6">
            ...
            <div className="lg:2/6 xl:w-2/4 mt-20 lg:mt-40 lg:ml-16 text-left">
              <div className="text-6xl font-bold text-gray-900 leading-none object-fit">
                <div className="bg-black w-[60%] h-[90%] text-center float-right rounded-3xl absolute inset-y-5 right-5 z-40">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r to-purple-600 from-sky-400 z-40">
                  Bring
                </span>{" "}
