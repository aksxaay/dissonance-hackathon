    ...
    <div className="min-h-screen min-w-full bg-gray-100 flex flex-col justify-center p-10">
      <div className="relative w-full max-w-full lg:max-w-6xl xl:max-w-screen-2xl mx-auto ">
          ...
          <div className="px-20 py-6">
            ...
            <div className="lg:2/6 xl:w-2/4 mt-20 lg:mt-40 lg:ml-16 text-left">
              ...
              <div className="mt-6 text-xl font-light text-true-gray-500 antialiased">
                A better experience for your attendees and exert less stress on your
                team.
              </div>
            </div>
        ...
        {showlive &&
          <div>
            <VideoFeed />
            <button onClick={() => setshowlive(false)} className="px-4 lg:px-10 py-2 rounded-3xl font-medium bg-gradient-to-b from-gray-900 to-black text-white outline-none focus:outline-none hover:shadow-md hover:from-true-gray-900 transition duration-200 ease-in-out z-[999]">
            close
                </button>
